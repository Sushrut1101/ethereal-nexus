            ...
            <div className="col-span-3">
                <div className="mx-auto">
                    <ReactMarkdown components={{
                        h1: ({node, ...props}) => <h1
                            className="scroll-m-20 text-4xl font-extrabold lg:text-5xl mb-4" {...props} />,
                        h2: ({node, ...props}) => <h2
                            className="scroll-m-20 text-3xl font-extrabold lg:text-4xl mb-4" {...props} />,
                        h3: ({node, ...props}) => <h3
                            className="scroll-m-20 text-2xl font-extrabold lg:text-3xl mb-4" {...props} />,
